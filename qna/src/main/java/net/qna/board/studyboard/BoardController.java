...
public class BoardController {
	...
	public ModelAndView list(@RequestParam(defaultValue="title") String searchOption, 
		...
		//레코드의 개수
		int count = boardDao.countboard(searchOption, keyword);
		...
		List<Board> list = boardDao.Viewlist(start, end, searchOption, keyword);
        ...
        mav.setViewName("board/studyboard"); // 뷰를 list.jsp로 설정
	...
	public String insert(@ModelAttribute Board vo, HttpSession session) throws Exception{
    ...
    public ModelAndView view(@RequestParam int bnum, HttpSession session) throws Exception{
		...
		String userId = boardDao.findByWriter(bnum);		
        ...
        mav.addObject("dto", boardDao.read(bnum));
        return mav;
    }
	//글 수정창으로 연결     
    ...
    public void multiplePhotoUpload(HttpServletRequest request, HttpServletResponse response){
        try {
             ...
             //파일 기본경로 _ 상세경로
             String filePath = dftFilePath + "resources" + File.separator +  "Editors" + File.separator + "uploadimg" + File.separator;
             ...
             sFileInfo += "&sFileURL="+"/resources/Editors/uploadimg/"+realFileNm;
