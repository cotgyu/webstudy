...
<script type="text/javascript" src="/resources/Editors/js/HuskyEZCreator.js?ver=1.1" charset="utf-8"></script> 
...
<body>
	...
	<h3>게시글 작성</h3>
	<form id="frm" method="post" action="/board/insert" enctype="multipart/form-data" method="${method}">
