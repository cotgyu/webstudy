...
<script type="text/javascript">
	...
	function listReply() {
		$.ajax({
			type : "get",
			url : "${path}/freply/list.do?bnum=${dto.bnum}",
	...
	function listReply2() {
		$.ajax({
			...
			url : "${path}/freply/listJson.do?bnum=${dto.bnum}",
			success : function(result) {
				console.log(result);
				var output = "<table>";
				for ( var i in result) {
...
<body>
	...
	<td>
		<div>
			...
			<button type="button" class="btn btn-default" onClick="location.href='/fboard/list'">목록</button>		
	</div>
	...
	<form name="form2" method="post" action="/freply/insert.do" method="${method}">
		<div style="width: 15%;">
			<br>
